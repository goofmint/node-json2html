...
(function() {
  var Client, app, client, express, fs, http, mu2Express, url;
  ...
  app.get("/*", function(req, response) {
    var ary, template, url_parts, view_path;
    ...
    return client.get('/api' + url_parts.pathname + '.json' + url_parts.search, function(err, res, body) {
